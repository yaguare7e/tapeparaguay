          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
            {TOOLS.map((tool) => (
              <Link
                ...
                className="group flex items-start gap-5 rounded-xl bg-white p-6 shadow-md ring-1 ring-gray-100 transition-all hover:-translate-y-1 hover:shadow-xl"
              >
                <div className={`flex h-14 w-14 shrink-0 items-center justify-center rounded-xl ${tool.color}`}>
                  <svg
                    className="h-7 w-7"
                    fill="none"
                    viewBox="0 0 24 24"
